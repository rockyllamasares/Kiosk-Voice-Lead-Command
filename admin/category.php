                    ...
                    <td><div class="row">
                      <form method="post">
                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                         <button type="button" name="getid" class="btn btn-warning btn-sm pr-2" data-toggle="modal" data-target="#edit">
                  Edit 
                </button>
                      </form>
            ...
            <div class="modal-body">
              ...
              <form method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label>Category Name</label>
                    <input class="form-control" type="text" name="cname" required="" value="<?php echo $row['category_name']; ?>">
                  </div>
