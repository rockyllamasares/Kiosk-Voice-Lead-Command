                ...
                <div>
                  ...
                  <?php do{ ?>
                    <form method="post" action="step1a.php">
                      <div class="filtr-item col-sm-4 pt-3" data-category="<?php echo $row['product_type']; ?>" data-sort="black sample">
                     
                        <img src="<?php echo (!empty($row['product_pic']))? 'admin/img/'.$row['product_pic']:'img/admin.png'; ?>" width="270px" height="150px" height="150" width="251" alt="white sample"/>
