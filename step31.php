...
if (isset($_POST['process'])) {
  ...
  $sql = "UPDATE orderlist SET order_stat = 1 WHERE order_number = '$ordernum'";
      ...
      <div class="col-md-8">
        ...
        <div class="card">
          <div class="card-header bg-info">
            ...
            <?php else: ?>
              <h3 class="card-title">Table Number:
                <?php echo $row['table_number']; ?><br>Order Number:
                  ...
                  <div class="row">
                    ...
                    <div class="pl-3">
                      <form method="post" action="index.php">
                        ...
                        <button type="submit" name="back" class="btn btn-warning">Finish Order</button>
                      </form>
                    </div>
